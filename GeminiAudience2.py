...
# ---------- 檢查是否已經評論過 ----------
def has_already_commented(image_path, filename="audience_feedback2.txt"):
...
# ---------- 儲存觀眾回應 ----------
def save_audience_response(response_text, image_path, filename="audience_feedback2.txt"):
